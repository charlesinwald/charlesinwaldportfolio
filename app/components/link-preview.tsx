...
export const HoverPeek = ({
  ...
  useEffect(() => {
    if (!isPeeking) {
      setImageLoadFailed(false);
      setIsLoading(true); // Reset loading state when card closes
                ...
                >
                  ...
                  {imageLoadFailed ? (
                    ...
                    <>
                      ...
                      {isLoading && (
                        <div
                          className="absolute inset-0 flex items-center justify-center bg-neutral-100/80 dark:bg-neutral-800/80 backdrop-blur-sm"
                          style={{ width: peekWidth, height: peekHeight }}
                        >
